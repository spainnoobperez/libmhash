...
int mutils_mlock(const void *addr, const mutils_word32 len);
int mutils_munlock(const void *addr, const mutils_word32 len);

void *mutils_malloc(const mutils_word32 n);
void *mutils_realloc(const void *ptr, const mutils_word32 n);
...
mutils_boolean mutils_thequals(mutils_word8 *text, mutils_word8 *hash, const mutils_word32 len);
